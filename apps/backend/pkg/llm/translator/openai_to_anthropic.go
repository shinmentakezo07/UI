...
// OpenAIToAnthropic translates OpenAI requests to Anthropic-compatible format.
...
func (t *OpenAIToAnthropic) Direction() Direction {
	return OpenAIToAnthropic
}

// TranslateRequest converts an OpenAI-style request to Anthropic format.
func (t *OpenAIToAnthropic) TranslateRequest(req *llm.ChatRequest) (map[string]interface{}, error) {
...
func (t *OpenAIToAnthropic) TranslateResponse(body []byte, model, provider string) (*llm.ChatResponse, error) {
...
func (t *OpenAIToAnthropic) TranslateStreamChunk(data []byte, model, provider string) (*llm.StreamChunk, error) {
	var chunk struct {
		Type    string `json:"type"`
...
func (t *OpenAIToAnthropic) ExtractAnthropicContent(body []byte) (string, string, llm.Usage, llm.FinishReason, error) {
