...
// AnthropicToOpenAI translates Anthropic requests to OpenAI-compatible format.
...
func (t *AnthropicToOpenAI) Direction() Direction {
	return AnthropicToOpenAI
}

// TranslateRequest converts an Anthropic-style request to OpenAI format.
func (t *AnthropicToOpenAI) TranslateRequest(req *llm.ChatRequest) (map[string]interface{}, error) {
...
func (t *AnthropicToOpenAI) TranslateResponse(body []byte, model, provider string) (*llm.ChatResponse, error) {
	content, usage, finishReason, err := t.ExtractOpenAIContent(body, model)
	if err != nil {
		return nil, err
	}
...
func (t *AnthropicToOpenAI) TranslateStreamChunk(data []byte, model, provider string) (*llm.StreamChunk, error) {
	var chunk struct {
		ID      string `json:"id"`
		Object  string `json:"object"`
		Created int64  `json:"created"`
...
func (t *AnthropicToOpenAI) ExtractOpenAIContent(body []byte, model string) (string, llm.Usage, llm.FinishReason, error) {
