    ...
    return (
        <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-[#000000]">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="absolute w-2.5 h-2.5 rounded-sm bg-blue-400/20 rotate-45 animate-orbit" style={{ animationDuration: "30s" }} />
            </div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
                ...
                >
                    <span className="block">Pay Per</span>
                ...
                >
                    Transparent, per-token pricing across{" "}
                    <span className="text-white font-medium">100+ AI models</span>.
