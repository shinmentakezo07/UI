...
function PlanCard({
    ...
    const accentMap: Record<string, { bg: string; ring: string; text: string; glow: string }> = {
        ...
        "text-yellow-400": { bg: "bg-yellow-500/20", ring: "ring-yellow-500/20", text: "text-yellow-400", glow: "rgba(234,179,8,0.3)" },
        "text-purple-400": { bg: "bg-purple-500/20", ring: "ring-purple-500/20", text: "text-purple-400", glow: "rgba(168,85,247,0.3)" },
    };
            ...
            <div className="glass-card rounded-[32px] p-1 relative overflow-hidden group h-full">
                ...
                <div className="relative h-full bg-[#0A0A0A] rounded-[28px] p-7 md:p-8 flex flex-col border border-white/5 z-10">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-white/[0.03] border border-white/5 w-fit mb-6">
                        <span className={`text-sm font-bold ${plan.color}`}>{plan.creditsDisplay}</span>
                        {plan.bonus && (
...
export function CreditPackages() {
    return (
        <section id="credits" className="relative w-full py-32 px-4 bg-[#050505] overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    >
                        ...
                        <span className="text-white font-medium">No subscriptions</span>, no expiry.
                    </motion.p>
                </div>
                ...
                >
                    {["No subscriptions", "Credits never expire", "Cancel anytime"].map((item) => (
                        <span
                            key={item}
