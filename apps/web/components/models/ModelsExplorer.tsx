...
const providerConfig: Record<string, { icon: typeof Cpu; color: string; gradient: string }> = {
    ...
    zhipuai: { icon: Activity, color: "text-cyan-400", gradient: "from-cyan-500/20 to-teal-500/20" },
    meta: { icon: Cpu, color: "text-indigo-400", gradient: "from-indigo-500/20 to-blue-500/20" },
    mistral: { icon: Activity, color: "text-rose-400", gradient: "from-rose-500/20 to-orange-500/20" },
    mistralai: { icon: Activity, color: "text-rose-400", gradient: "from-rose-500/20 to-orange-500/20" },
    deepseek: { icon: Cpu, color: "text-teal-400", gradient: "from-teal-500/20 to-emerald-500/20" },
    "deepseek-ai": { icon: Cpu, color: "text-teal-400", gradient: "from-teal-500/20 to-emerald-500/20" },
    xai: { icon: Cpu, color: "text-red-400", gradient: "from-red-500/20 to-orange-500/20" },
    alibaba: { icon: Cpu, color: "text-orange-400", gradient: "from-orange-500/20 to-red-500/20" },
    qwen: { icon: Cpu, color: "text-orange-400", gradient: "from-orange-500/20 to-red-500/20" },
    qw: { icon: Brain, color: "text-purple-400", gradient: "from-purple-500/20 to-pink-500/20" },
    gpt: { icon: Sparkles, color: "text-green-400", gradient: "from-green-500/20 to-emerald-500/20" },
    claude: { icon: Zap, color: "text-orange-400", gradient: "from-orange-500/20 to-amber-500/20" },
    gemini: { icon: Star, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20" },
    llama: { icon: Cpu, color: "text-indigo-400", gradient: "from-indigo-500/20 to-blue-500/20" },
    minimax: { icon: Activity, color: "text-pink-400", gradient: "from-pink-500/20 to-rose-500/20" },
    minimaxai: { icon: Activity, color: "text-pink-400", gradient: "from-pink-500/20 to-rose-500/20" },
    glm: { icon: Activity, color: "text-cyan-400", gradient: "from-cyan-500/20 to-teal-500/20" },
};
...
function getProviderDisplayName(providerId: string): string {
    ...
    return map[providerId] || providerId.charAt(0).toUpperCase() + providerId.slice(1);
}

const providers = ["All", "OpenAI", "Anthropic", "Google", "Moonshot", "Meta", "Mistral", "DeepSeek", "xAI"];
    ...
    return (
        <section className="relative w-full pt-8 pb-24 md:pt-12 md:pb-32 px-4 bg-[#000000] overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-1/3 right-1/4 w-[500px] h-[500px] bg-violet-600/5 rounded-full blur-[140px] animate-glow-pulse" style={{ animationDelay: "2s" }} />
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <span className="text-white font-medium">100+ AI models</span> from leading
                ...
                {filteredModels.length > 0 && (
                    ...
                    >
                        {[
                            ...
                            { label: "Popular Picks", value: models.filter((m) => m.popular).length },
                        ].map((stat) => (
                            <div
                                key={stat.label}
